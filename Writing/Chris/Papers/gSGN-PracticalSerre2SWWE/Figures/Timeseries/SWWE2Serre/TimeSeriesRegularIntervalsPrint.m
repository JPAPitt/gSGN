...
wdir = "/home/jp/Documents/Work/PostDoc/Projects/Steve/1DWaves/RegularisedSerre/Data/RAW/Models/gSGNForcedLimhG/BetaFunc/SWWE2Serre/SmoothDB/alpha0p1/timeseries/exp1/";
...
matlab2tikz('SWWE2Serre10to20A.tex');
...
for k = 1:size(times,2)
    ...
    matlab2tikz( strcat('SWWE2Serre10to20',65+ k,'.tex'));
...
matlab2tikz( strcat('SWWE2Serre10to20',65+ k + 1,'.tex'));
