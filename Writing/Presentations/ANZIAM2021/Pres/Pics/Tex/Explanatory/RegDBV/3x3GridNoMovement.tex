...
{\includegraphics[width=0.45\textwidth]{AllTextNA.pdf}};
\node[inner sep=0pt] (SWWE) at (-4.5,-3)
{\includegraphics[width=0.3\textwidth]{RegionSWWEA.pdf}};

\draw[->,dotted,thick,opacity=0.5] (-2.5,-1.9) -- (-3.5,-2.5) ;

\node[inner sep=0pt] (rSV) at (-4.5,1.8)
{\includegraphics[width=0.3\textwidth]{RegionrSVA.pdf}};

\draw[->,dotted,thick,opacity=0.5] (-1.9,-1.35) -- (-3,0.5) ;

\node[inner sep=0pt] (Serre) at (4.5,-3)
{\includegraphics[width=0.3\textwidth]{RegionSerreA.pdf}};

\draw[->,dotted,thick,opacity=0.5] (1.65,-1.3) -- (3,0.2) ;

\node[inner sep=0pt] (Serre) at (4.5,1.8)
{\includegraphics[width=0.3\textwidth]{RegioniSGNA.pdf}};

\draw[->,dotted,thick,opacity=0.5] (0.9,-1.9) -- (2.7,-2.7) ;

%\draw[->,dotted,thick,opacity=0.5] (-2.5,-1.9) -- (-3.5,-2.5) ;


%\node[inner sep=0pt] (SWWE) at (-4.5,4)
%{\includegraphics[width=0.3\textwidth]{RegionSWWE.pdf}};
%\draw[->,dotted,thick,opacity=0.5] (-1.8,-1.29) -- (-4.,2.5) ;

%\node[inner sep=0pt] (rSV) at (-4.5,4)
%{\includegraphics[width=0.3\textwidth]{RegionrSV.pdf}};
%\draw[->,dotted,thick,opacity=0.5] (-2.2,-1.6) -- (-3.5,-2.5) ;
%
