...
\draw[dashed,black,ultra thick] (0,0) --   (1,1) ;

\draw[-,blue,ultra thick,dashed] (2/3,0) --   (1,1/3) ;
\addplot[draw=none,blue,decoration={text along path,
	text={|\Large| Non-Dispersive},
	raise=-3ex,
	text color={black},
...
\addplot[mark=*,blue, mark size = 4pt] coordinates {(0.666,0)};

\addplot[mark=*,red, mark size = 4pt] coordinates {(0.8,0.133333)};

%\node[] at (axis cs: 0.15,0.05) {SWWE};

%\node[] at (axis cs: 0.55,0.05) {\color{blue} Serre ($k^2$ term)};

%\node[] at (axis cs: 0.63,0.3) {\color{red} Optimal \\\color{red} Improved Serre ($k^4$ term)};

\draw[->,black,line width=1mm ] (0.666,0) --   (0.8,0.133333) ;
\draw[->,black,line width=1mm ] (0.8,0.133333) -- (0.133333,0.133333) ;
\draw[->,black,line width=1mm ] (0.133333,0.133333) -- (0.01,0.01) ;

\node[] at (axis cs: 0.8,0.025) {$t<50s$};
\node[] at (axis cs: 0.8,0.2) {$50s\le t <100s$};
\node[] at (axis cs: 0.18,0.2) {$100s\le t <150s$};
\node[] at (0.15,0.03) {$t>150s$};
