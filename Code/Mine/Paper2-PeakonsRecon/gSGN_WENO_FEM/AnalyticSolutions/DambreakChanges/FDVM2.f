...
c Cell Average To Cubic
     ...
     .    - cellavgbc_q(i+2)/6 + cellavgbc_q(i+3)/24
      ...
      Bjm3toj =  1867*cellavgbc_q(i)**2/240 
     . - 1327*cellavgbc_q(i)*cellavgbc_q(i-1)/40 
     . + 2801*cellavgbc_q(i)*cellavgbc_q(i-2)/120 
     . - 229*cellavgbc_q(i)*cellavgbc_q(i-3)/40 
     . + 8843*cellavgbc_q(i-1)**2/240 
     . - 6463*cellavgbc_q(i-1)*cellavgbc_q(i-2)/120 
     . + 1601*cellavgbc_q(i-1)*cellavgbc_q(i-3)/120 
     . + 4883*cellavgbc_q(i-2)**2/240 
     . - 407*cellavgbc_q(i-2)*cellavgbc_q(i-3)/40 
     . + 307*cellavgbc_q(i-3)**2/240
      
      Bjm2tojp1 = 1283*cellavgbc_q(i)**2/240 
     . - 541*cellavgbc_q(i)*cellavgbc_q(i+1)/120 
     . - 823*cellavgbc_q(i)*cellavgbc_q(i-1)/120 
     . + 27*cellavgbc_q(i)*cellavgbc_q(i-2)/40 
     . + 307*cellavgbc_q(i+1)**2/240 
     . + 241*cellavgbc_q(i+1)*cellavgbc_q(i-1)/120 
     . - 7*cellavgbc_q(i+1)*cellavgbc_q(i-2)/120 
     . + 683*cellavgbc_q(i-1)**2/240 
     . - 101*cellavgbc_q(i-1)*cellavgbc_q(i-2)/120 
     . + 9*cellavgbc_q(i-2)**2/80


      Bjm1tojp2 = 1283*cellavgbc_q(i)**2/240 
     . - 823*cellavgbc_q(i)*cellavgbc_q(i+1)/120 
     . + 27*cellavgbc_q(i)*cellavgbc_q(i+2)/40 
     . - 541*cellavgbc_q(i)*cellavgbc_q(i-1)/120 
     . + 683*cellavgbc_q(i+1)**2/240 
     ...
     . + 241*cellavgbc_q(i+1)*cellavgbc_q(i-1)/120 
     . + 9*cellavgbc_q(i+2)**2/80 
     . - 7*cellavgbc_q(i+2)*cellavgbc_q(i-1)/120 
     . + 307*cellavgbc_q(i-1)**2/240
      
      Bjtojp3 =1867*cellavgbc_q(i)**2/240 
     . - 1327*cellavgbc_q(i)*cellavgbc_q(i+1)/40 
     . + 2801*cellavgbc_q(i)*cellavgbc_q(i+2)/120 
     . - 229*cellavgbc_q(i)*cellavgbc_q(i+3)/40 
     . + 8843*cellavgbc_q(i+1)**2/240 
