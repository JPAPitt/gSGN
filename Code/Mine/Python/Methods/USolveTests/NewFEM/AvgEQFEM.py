...
def FEMElem(hR,GR,beta1,dx,j):
    ...
    AMatE[0][0] = 3*beta1*hjmh**3/dx**2 + hjmh
    AMatE[0][1] = -3*beta1*dhjmh*hjmh**2/2 + 2*beta1*hjmh**3/dx
    AMatE[0][2] = -3*beta1*hjmh**3/dx**2
    AMatE[0][3] = beta1*hjmh**3/dx
    
    AMatE[1][0] = -3*beta1*hjph**3/dx**2
    AMatE[1][1] = -beta1*hjph**3/dx
    AMatE[1][2] = 3*beta1*hjph**3/dx**2 + hjph
    AMatE[1][3] = -3*beta1*dhjph*hjph**2/2 - 2*beta1*hjph**3/dx  
...
h,G,u,x = InitialSolitonPointwise(xn,dx,t,ga,a0,a1,2.0/3.0)
