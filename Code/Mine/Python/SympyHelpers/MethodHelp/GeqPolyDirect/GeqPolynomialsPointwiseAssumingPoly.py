...
Gjph,Gjps,Gjms,Gjmh,SGj,hjph,hjps,hjms,hjmh,Shj = symbols('G_{j+1/2} G_{j+1/6} G_{j-1/6} G_{j-1/2} G_j h_{j+1/2} h_{j+1/6} h_{j-1/6} h_{j-1/2} h_j',real=True)
ujph,ujps,ujms,ujmh,Suj = symbols('u_{j+1/2} u_{j+1/6} u_{j-1/6} u_{j-1/2} u_j',real=True)

Sdhjph,Sdhjps,Sdhjms,Sdhjmh,Sdhj =  symbols('h^d_{j+1/2} h^d_{j+1/6} h^d_{j-1/6} h^d_{j-1/2} h^{d}_j',real =True)
