...
dujps= diff(uPoly,x).doit().subs(x,dx/6).simplify()
dujms= diff(uPoly,x).doit().subs(x,-dx/6).simplify()

dhjph= diff(hPoly,x).doit().subs(x,dx/2).simplify()
dhjmh= diff(hPoly,x).doit().subs(x,-dx/2).simplify()
dhjps= diff(hPoly,x).doit().subs(x,dx/6).simplify()
dhjms= diff(hPoly,x).doit().subs(x,-dx/6).simplify()

ddujph= diff(uPoly,(x,2)).doit().subs(x,dx/2).simplify()
ddujmh= diff(uPoly,(x,2)).doit().subs(x,-dx/2).simplify()
ddujps= diff(uPoly,(x,2)).doit().subs(x,dx/6).simplify()
ddujms= diff(uPoly,(x,2)).doit().subs(x,-dx/6).simplify()


Geq = u*h - b1*diff(h**3*diff(u,x), x)

#Simpsons 3/8 rule to integrate uh
# GeqInt = dx/8*(hjmh*ujmh + 3*hjms*ujms + 3*hjps*ujps + hjmh*ujmh) - (b1*hjph**3*dujph - b1*hjmh**3*dujmh)
...
Geqjms = Geq.subs(diff(u,(x,2)),ddujms ).subs(diff(u,(x)),dujms ).subs(u,ujms ).subs(diff(h,(x)),Sdhjms ).subs(h,hjms )
Geqjms =Geqjms.expand()

Geqjps = Geq.subs(diff(u,(x,2)),ddujps ).subs(diff(u,(x)),dujps ).subs(u,ujps ).subs(diff(h,(x)),Sdhjps ).subs(h,hjps )
Geqjps =Geqjps.expand()
...
Eq1ujmhC = Eq1ujph.subs(Gjmh,0).subs(ujmh,1).subs(ujms,0).subs(ujps,0).subs(ujph,0)
Eq1ujmsC = Eq1ujph.subs(Gjmh,0).subs(ujmh,0).subs(ujms,1).subs(ujps,0).subs(ujph,0)
Eq1ujpsC = Eq1ujph.subs(Gjmh,0).subs(ujmh,0).subs(ujms,0).subs(ujps,1).subs(ujph,0)
Eq1ujphC = Eq1ujph.subs(Gjmh,0).subs(ujmh,0).subs(ujms,0).subs(ujps,0).subs(ujph,1)
...
Eq2ujmhC = Eq2ujph.subs(Gjms,0).subs(ujmh,1).subs(ujms,0).subs(ujps,0).subs(ujph,0)
Eq2ujmsC = Eq2ujph.subs(Gjms,0).subs(ujmh,0).subs(ujms,1).subs(ujps,0).subs(ujph,0)
Eq2ujpsC = Eq2ujph.subs(Gjms,0).subs(ujmh,0).subs(ujms,0).subs(ujps,1).subs(ujph,0)
Eq2ujphC = Eq2ujph.subs(Gjms,0).subs(ujmh,0).subs(ujms,0).subs(ujps,0).subs(ujph,1)
...
Eq3ujmhC = Eq3ujph.subs(Gjps,0).subs(ujmh,1).subs(ujms,0).subs(ujps,0).subs(ujph,0)
Eq3ujmsC = Eq3ujph.subs(Gjps,0).subs(ujmh,0).subs(ujms,1).subs(ujps,0).subs(ujph,0)
Eq3ujpsC = Eq3ujph.subs(Gjps,0).subs(ujmh,0).subs(ujms,0).subs(ujps,1).subs(ujph,0)
Eq3ujphC = Eq3ujph.subs(Gjps,0).subs(ujmh,0).subs(ujms,0).subs(ujps,0).subs(ujph,1)

Eq3R = Eq3ujph.subs(Eq3ujpsC,c2).subs(Eq3ujmhC,c0).subs(Eq3ujmsC,c1).subs(Eq3ujphC,c3)
...
Eq4ujmhC = Eq4ujph.subs(Gjph,0).subs(ujmh,1).subs(ujms,0).subs(ujps,0).subs(ujph,0)
Eq4ujmsC = Eq4ujph.subs(Gjph,0).subs(ujmh,0).subs(ujms,1).subs(ujps,0).subs(ujph,0)
Eq4ujpsC = Eq4ujph.subs(Gjph,0).subs(ujmh,0).subs(ujms,0).subs(ujps,1).subs(ujph,0)
Eq4ujphC = Eq4ujph.subs(Gjph,0).subs(ujmh,0).subs(ujms,0).subs(ujps,0).subs(ujph,1)
