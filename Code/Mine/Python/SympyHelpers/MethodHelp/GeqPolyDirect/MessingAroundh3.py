...
GPolyEq = hPoly*uPoly - b1/2.0*diff(hPoly**3 *diff(uPoly,x), x)
...
GPolyEqxCutoffx0 = GPolyEqxCutoff.subs(x**10,0).subs(x**9,0).subs(x**8,0).subs(x**7,0).subs(x**6,0).subs(x**5,0).subs(x**4,0).subs(x**3,0).subs(x**2,0).subs(x**1,0)

GPolyEqxCutoffx1 = GPolyEqxCutoff - GPolyEqxCutoffx0
GPolyEqxCutoffx1 = GPolyEqxCutoffx1.subs(x**10,0).subs(x**9,0).subs(x**8,0).subs(x**7,0).subs(x**6,0).subs(x**5,0).subs(x**4,0).subs(x**3,0).subs(x**2,0).subs(x**1,1)

GPolyEqxCutoffx2 = GPolyEqxCutoff - GPolyEqxCutoffx0
GPolyEqxCutoffx2 = GPolyEqxCutoffx2.subs(x**10,0).subs(x**9,0).subs(x**8,0).subs(x**7,0).subs(x**6,0).subs(x**5,0).subs(x**4,0).subs(x**3,0).subs(x**2,1).subs(x**1,0)

GPolyEqxCutoffx3 = GPolyEqxCutoff - GPolyEqxCutoffx0
GPolyEqxCutoffx3 = GPolyEqxCutoffx3.subs(x**10,0).subs(x**9,0).subs(x**8,0).subs(x**7,0).subs(x**6,0).subs(x**5,0).subs(x**4,0).subs(x**3,1).subs(x**2,0).subs(x**1,0)
