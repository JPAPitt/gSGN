...
witerms = ["wjm1o2","wjm1o6","wjp1o6","wjp1o2"]
hterms = ['hjmh','hjms','hjps','hjph']


#Iterate over the number of elements in the matrix
for i in range(m):
    #variable name to be assigned
    string = termname + indexes[i] + " = " + termmult + "("
    ...
    for j in range(ni):
        ...
        for k in range(lm2):
            ...
            if(Names[ni*i + j][k] in witerms):                
                indc = witerms.index(Names[ni*i + j][k])
