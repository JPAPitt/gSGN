...
dfluxGdx = diff(u*G + ga*h**2/2 - beta1*h**3*diff(u,x)**2 ,x)
...
#Forced solutions
a0,a1,a2,a3,a4,a5,b1a6,b1a7,b2a6,b2a7 = symbols('a0,a1,a2,a3,a4,a5,b1a6,b1a7,b2a6,b2a7', positive = True, nonzero = True)
