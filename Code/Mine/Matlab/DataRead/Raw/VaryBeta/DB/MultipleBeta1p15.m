...
wdir = '/home/jp/Documents/Work/PostDoc/Projects/Steve/1DWaves/RegularisedSerre/Data/RAW/Models/gSGN/VaryBeta/ImpDisp/';
...
for k = begi:bege
    ...
    plot(x1,h1,'-','DisplayName',strcat("\beta's = ",num2str(1.0/15.0*k) ));
end
legend('show');
hold off
