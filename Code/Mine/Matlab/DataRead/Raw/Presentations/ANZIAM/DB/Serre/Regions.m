...
wdirbase = "/home/jp/Documents/Work/PostDoc/Projects/Steve/1DWaves/RegularisedSerre/Data/RAW/Models/gSGN_NoLim/Examples/DBNew/";
wdir = "00/";

expdir = strcat(wdirbase,wdir);
...
beta1 = str2double(beta1str{1,1}) + 2.0/3.0;
...
Region2ub = (u2 - sqrt(ga*h2)*sqrt(beta2/ (beta1)))*t;
Region3ub = (u2)*t;
Region4ub = (u2 + sqrt(ga*h2)*sqrt(beta2/ (beta1)))*t;
...
plot(x,h,'-k','DisplayName',strcat('\beta_2=',num2str(beta2)));
xlabel('x (m)');
ylabel('h (m)');
