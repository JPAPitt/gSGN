...
matlab2tikz('Serre2SWWE10to20FocusA.tex');
...
for k = 1:size(times,2)
    ...
    matlab2tikz( strcat('Serre2SWWE10to20Focus',65+ k,'.tex'));
...
matlab2tikz( strcat('Serre2SWWE10to20Focus',65+ k + 1,'.tex'));
