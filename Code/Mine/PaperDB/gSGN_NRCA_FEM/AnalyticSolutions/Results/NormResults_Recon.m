...
figure;
% loglog(dx,Normh,'s b',dx,NormG,'o r',dx,Normu,'^ k' , dx, dx.^2,'-k',dx, 0.05*dx.^4,'-k' ,dx,  0.05*dx.^3,'-k', 'MarkerSize',8);
loglog(dx,Normh,'s b',dx,NormG,'o r',dx,Normu,'^ k' ,dx, 0.05*dx.^4,'-k', 'MarkerSize',8);legend('h','G', 'u');
xlabel('\Delta x');
ylabel('L_2');
% 
% clc;
