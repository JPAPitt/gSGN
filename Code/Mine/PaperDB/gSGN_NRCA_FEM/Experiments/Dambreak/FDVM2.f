...
c subroutine that cubics, calculates flux across 
     ...
     . + 9*hcub(4*(i+1)-1)  - hcub(4*(i+1)))/ 16.0
      ...
      ddhir = 0.5*(ddhip1l + ddhir) 
      ddhip1l = ddhir     


      dhir = 0.5*(dhip1l + dhir) 
      dhip1l = dhir         
       
c      print *,i ,'Derivs',duir,duip1l,dhir,dhip1l,ddhir,ddhip1l
     ...
     .      - beta2/4d0*ga*(hip1l**2)*(2*hip1l*ddhip1l + (dhip1l**2))
      ...
      print *,i,felh,ferh,felG,ferG
      print *, 'left', hir,duir,dhir,ddhir
      print *, 'right', hip1l,duip1l,dhip1l,ddhip1l
      if (sr == sl) then
         isrmsl = 0.0
      else
         isrmsl = 1.0 / (sr - sl)
