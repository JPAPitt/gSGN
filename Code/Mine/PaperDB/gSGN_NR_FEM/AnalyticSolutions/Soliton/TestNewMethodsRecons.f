...
c    
     ...
     .      nGhstCells,dx,dt
c         call EvolveStepWrap(xbc_len,cubbc_len,ha_bc,Ga_bc,10.0,
c     . beta1,beta2,10.0**(-12),nGhstCells,dx,dx, 
c     . hcubN_bc,GcubN_bc,ucubN_bc)
     
c        print *, 'Recon',cubic_len,xbc_len, nGhstCells,dx
        call CellAverageToCubic(cubbc_len,xbc_len,
     . nGhstCells,ha_bc,dx,hcubN_bc,10.0**(-12))

        call CellAverageToCubic(cubbc_len,xbc_len,
     . nGhstCells,Ga_bc,dx,GcubN_bc,10.0**(-12))     
        ! test reconstruction
...
c     .   cubbc_len, 3*xbc_len + 1,nGhstCells)
        ...
        call FEMforU(hcub_bc,Gcub_bc,ucubN_bc,beta1,dx,xbc_len,
