...
c      print *, 'MM O',e,omin,omax
      ...
      subroutine EdgeValuesPjm2j(qajm2,qajm1,qaj,qjmh,qjph)
      implicit none
      DOUBLE PRECISION qajm2,qajm1,qaj,qjmh,qjph
      qjmh = qaj/3 + 5*qajm1/6 - qajm2/6
      qjph = 11*qaj/6 - 7*qajm1/6 + qajm2/3    
      end

      subroutine EdgeValuesPjm1jp1(qajm1,qaj,qajp1,qjmh,qjph)
      implicit none
      DOUBLE PRECISION qajm1,qaj,qajp1,qjmh,qjph
      qjmh = 5*qaj/6 - qajp1/6 + qajm1/3
      qjph = 5*qaj/6 + qajp1/3 - qajm1/6    
      end

      subroutine EdgeValuesPjjp2(qaj,qajp1,qajp2,qjmh,qjph)
      implicit none
      DOUBLE PRECISION qaj,qajp1,qajp2,qjmh,qjph
      qjmh = 11*qaj/6 - 7*qajp1/6 + qajp2/3
      qjph = qaj/3 + 5*qajp1/6 - qajp2/6 
      end

      subroutine EdgeValuesPjm3j(qajm3,qajm2,qajm1,qaj,qjmh,qjph)
      implicit none
      DOUBLE PRECISION qajm3,qajm2,qajm1,qaj,qjmh,qjph
      qjmh = qaj/4 + 13*qajm1/12 - 5*qajm2/12 + qajm3/12
      qjph = 25*qaj/12 - 23*qajm1/12 + 13*qajm2/12 - qajm3/4 
      end

      subroutine EdgeValuesPjm2jp1(qajm2,qajm1,qaj,qajp1,qjmh,qjph)
      implicit none
      DOUBLE PRECISION qajm2,qajm1,qaj,qajp1,qjmh,qjph
      qjmh = 7*qaj/12 + 7*qajm1/12 - qajm2/12 - qajp1/12
      qjph = 13*qaj/12 - 5*qajm1/12 + qajm2/12 + qajp1/4
      end

      subroutine EdgeValuesPjm1jp2(qajm1,qaj,qajp1,qajp2,qjmh,qjph)
      implicit none
      DOUBLE PRECISION qajm1,qaj,qajp1,qajp2,qjmh,qjph
      qjmh = 13*qaj/12 + qajm1/4 - 5*qajp1/12 + qajp2/12
      qjph = 7*qaj/12 - qajm1/12 + 7*qajp1/12 - qajp2/12
      end

      subroutine EdgeValuesPjjp3(qaj,qajp1,qajp2,qajp3,qjmh,qjph)
      implicit none
      DOUBLE PRECISION qaj,qajp1,qajp2,qajp3,qjmh,qjph
      qjmh = 25*qaj/12 - 23*qajp1/12 + 13*qajp2/12 - qajp3/4
      qjph = qaj/4 + 13*qajp1/12 - 5*qajp2/12 + qajp3/12
      end
      
      subroutine P3Avgjm1jEdges(qajm1,qaj,qjmh,qjph,dx,pa,pb,pc,pd)
      implicit none
      DOUBLE PRECISION qajm1,qaj,qjmh,qjph,dx,pa,pb,pc,pd
      ...
      subroutine P3Avgjjp1Edges(qaj,qajp1,qjmh,qjph,dx,pa,pb,pc,pd)
      implicit none
      DOUBLE PRECISION qaj,qajp1,qjmh,qjph,dx,pa,pb,pc,pd
...
c Cell Average To Cubic
     ...
     . nGhstCells,cellavgbc_q,dx,cubicbc_q,calctol)
      ...
      integer i
      DOUBLE PRECISION p1jm1toja1,p1jm1toja0,
     . p1jtojp1a1,p1jtojp1a0,p1Wa1,p1Wa0,p1Ra1,
     . pR1mh,pR1ph,
     . p2jm2tojmh,p2jm2tojph,p2jm1tojp1mh,p2jm1tojp1ph,
     . p2jtojp2mh,p2jtojp2ph,
     . pR2mh,pR2ph,
     . p3jm3tojmh,p3jm3tojph,p3jm2tojp1mh,p3jm2tojp1ph,
     . p3jm1tojp2mh,p3jm1tojp2ph,p3jtojp3mh,p3jtojp3ph,
     . pR3mh,pR3ph,
     . pR3pa,pR3pb,pR3pc,pR3pd,
     . pR3ma,pR3mb,pR3mc,pR3md,
     . R3a,R3b,R3c,R3d 
     ...
     .    dx,p1Wa1,p1Wa0)
         ...
         call minmod(p1Wa1,p1jm1toja1,p1jtojp1a1,p1jtojp1a1,p1Ra1)
         pR1mh = p1Ra1*(-dx/2) + cellavgbc_q(i)
         pR1ph = p1Ra1*(dx/2) + cellavgbc_q(i)
         
         call EdgeValuesPjm2j(cellavgbc_q(i-2),cellavgbc_q(i-1),
     .    cellavgbc_q(i),p2jm2tojmh,p2jm2tojph)
         call EdgeValuesPjm1jp1(cellavgbc_q(i-1),cellavgbc_q(i),
     .    cellavgbc_q(i+1),p2jm1tojp1mh,p2jm1tojp1ph) 
         call EdgeValuesPjjp2(cellavgbc_q(i),cellavgbc_q(i+1),
     .    cellavgbc_q(i+2),p2jtojp2mh,p2jtojp2ph)  

         call minmod(p2jm2tojmh - pR1mh ,p2jm1tojp1mh - pR1mh,
     .    p2jtojp2mh - pR1mh,p2jtojp2mh - pR1mh,pR2mh)
         pR2mh = pR2mh + pR1mh
         call minmod(p2jm2tojph - pR1ph ,p2jm1tojp1ph - pR1ph,
     .    p2jtojp2ph - pR1ph,p2jtojp2ph - pR1ph,pR2ph)
         pR2ph = pR2ph + pR1ph

         call EdgeValuesPjm3j(cellavgbc_q(i-3),cellavgbc_q(i-2),
     .    cellavgbc_q(i-1),cellavgbc_q(i),p3jm3tojmh,p3jm3tojph)       
         call EdgeValuesPjm2jp1(cellavgbc_q(i-2),cellavgbc_q(i-1),
     .    cellavgbc_q(i),cellavgbc_q(i),p3jm2tojp1mh,p3jm2tojp1ph)   
         call EdgeValuesPjm1jp2(cellavgbc_q(i-1),cellavgbc_q(i),
     .    cellavgbc_q(i+1),cellavgbc_q(i+2),p3jm1tojp2mh,p3jm1tojp2ph)  
         call EdgeValuesPjjp3(cellavgbc_q(i),cellavgbc_q(i+1),
     .    cellavgbc_q(i+2),cellavgbc_q(i+3),p3jtojp3mh,p3jtojp3ph) 

         call minmod(p3jm3tojmh - pR2mh ,p3jm2tojp1mh - pR2mh,
     .    p3jm1tojp2mh - pR2mh,p3jtojp3mh - pR2mh,pR3mh)
         pR3mh = pR3mh + pR2mh
         call minmod(p3jm3tojph - pR2ph ,p3jm2tojp1ph - pR2ph,
     .    p3jm1tojp2ph - pR2ph,p3jtojp3ph - pR2ph,pR3ph)
         pR3ph = pR3ph + pR2ph
         
         
         call P3Avgjm1jEdges(cellavgbc_q(i-1),cellavgbc_q(i),
     .    pR3mh,pR3ph,dx,pR3ma,pR3mb,pR3mc,pR3md)
         call P3Avgjjp1Edges(cellavgbc_q(i),cellavgbc_q(i+1),
     .    pR3mh,pR3ph,dx,pR3pa,pR3pb,pR3pc,pR3pd)
