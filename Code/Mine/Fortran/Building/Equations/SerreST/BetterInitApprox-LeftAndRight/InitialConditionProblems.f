...
c =====      
      ...
      do i=3,x_len-2
         ...
         if (phi .LT. 0) then
            ...
            nim3= a1*dexp(-dsqrt(3d0)*dabs(phim3))
            nx = (3*ni - 4*nim1 + nim2)/ (2*dx)
            nxx = (2*ni - 5*nim1 + 4*nim2 - nim3)/ (dx*dx)
            ...
            nip3= a1*dexp(-dsqrt(3d0)*dabs(phip3))
            nx = (-3*ni + 4*nip1 - nip2)/ (2*dx)
            nxx = (2*ni - 5*nip1 + 4*nip2 - nip3)/ (dx*dx)
