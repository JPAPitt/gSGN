...
c ===
     ...
     . xbc_len,dx,ga,beta1,beta2)
      ...
      do j = 1,16
      if (j .eq. 4) then
         READ(1,*) str1, str1 , nGhstcell
      else if (j .eq. 5) then
         READ(1,*) str1, str1 , xbc_len
      else if (j .eq. 6) then
         READ(1,("(42X,E23.17E4)"))  dx
      else if (j .eq. 11) then
         READ(1,*) str1, str1 , ga
      else if (j .eq. 15) then
         READ(1,*) str1, str1 , beta1
      else if (j .eq. 16) then
         READ(1,*) str1, str1 , beta2
      else
         READ(1,*) str1,str1
      end if
...
c     .    "REGSWWE/AspRat2to1/DBalpha0p1/Beta05/dx06/"
     ...
     . "Params.dat", 10,ts_len,ts,Energys)
      ...
      open(2, file = 'SWWESolver_DB_ETS.dat') 
      do j = 1,ts_len
