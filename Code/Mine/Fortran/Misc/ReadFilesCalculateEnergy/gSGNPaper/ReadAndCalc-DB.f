...
c      call ReadResFile(wdir//'End.dat',wdir_len +7,
c     .   xbc_len,nGhstcell,ga, beta1,beta2,dx,ts(j),Energys(j,:))
      end
...
c get length of string without trailing whitespace      
     ...
     . (resultval .LE. n )  )
      ...
      PARAMETER(wdirlen= 200,ts_len=36)
     ...
     . "1DWaves/RegularisedSerre/Data/RAW/Models/gSGN_NoLim/" //
     . "AnalyticSolutions/DBSWWETheta1/"     
