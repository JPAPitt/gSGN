...
c Conservation Norm Tests  
     ...
     . "/ConstantBeta/SmoothDBInvestigation/" //
     . "AspRat10to1/DBalph0p1/test4/"
      ...
      !open output files
      open(EnergFile, file = wdir(1:effeclenwdir) //
     .      'EnergyErr.dat') 
      open(NormFile, file = wdir(1:effeclenwdir) //
     .      'NormsErr.dat') 
