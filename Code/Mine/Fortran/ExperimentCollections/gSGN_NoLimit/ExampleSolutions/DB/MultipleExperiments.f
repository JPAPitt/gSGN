...
c         x_len = lowestresx *2**(expi)
c         xbc_len = x_len + 2 *n_GhstCells
         ...
         if (expi .EQ. 0) then
            ...
            beta1 = -2d0/3d0
            beta2 = 0d0
         else if (expi .EQ. 3) then
            beta1 = -2d0/3d0 + 1d0
            beta2 = 1d0      
         else if (expi .EQ. 4) then
            beta1 = 1d0/3d0 -2d0/3d0
            beta2 = 2d0/3d0               
         end if      
     ...
     .    x_len , '++++++++++++'
         ...
         call SingleSWWEDB(hl,hr,ga,beta1,beta2,
     . xstart,xbc_len,n_GhstCells,dx,tstart,tend,
     . dt,theta,NormFile,EnergFile,tlist,tlist_len,
