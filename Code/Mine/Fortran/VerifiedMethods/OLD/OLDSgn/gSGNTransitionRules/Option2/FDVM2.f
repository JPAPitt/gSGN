...
c ==================      
     ...
     . RHS(xbc_len)
      ...
      DOUBLE PRECISION ht1,ht2,dhf,dhm,dhb,dhc,a0,a1,a2,a3
      ...
      do i=n_GhstCells+1,xbc_len - n_GhstCells 
         ...
         dhf =(hbc(i+1) - hbc(i))/hbc(i)
         dhm =(hbc(i+1) - hbc(i-1))/hbc(i)
         dhb =(hbc(i) - hbc(i-1))/hbc(i)
         call minmod(dhf,dhm,dhb,dhc)
         ...
         if (dhc .LE. a0) then
            ...
            beta1 = -2d0/3d0 + (2d0/3d0)*(dhc - a0)/(a1 - a0)
         else if (( dhc .GT. a1)  .AND. (dhc .LE. a2)) then
            beta1 = 0d0 
         else if (( dhc .GT. a2)  .AND. (dhc .LE. a3)) then
            beta1 =  - (2d0/3d0)*(dhc - a2)/(a3 - a2)
         else 
            beta1 = -2d0/3d0
         end if 
...
c across cell i +1 (which will be cell i as the method moves to the next cell)    
     ...
     . dhir,ddhir,dhip1l,ddhip1l, alpha,dhc,dhm,dhf,dhb,a0,a1,a2,a3
